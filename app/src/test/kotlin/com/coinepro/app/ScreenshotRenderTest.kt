...
private val LEGAL_EXCERPT = """
    ...
    **آخرین بازنگری:** ۱۴۰۵/۰۶/۰۴
    ...
    ## ۲) ماهیت سرویس — ابزار تحلیل، نه توصیه‌ی مالی

    پرو چارت **کارگزار نیست**، پول شما را نگه نمی‌دارد و مشاوره‌ی مالی نمی‌دهد. شرح کامل در
    ...
    private val posts = listOf(
        CommunityPost(
            ...
            content = "طلا از سقف کانال روزانه برگشت و الان روی ۲۶۴۰ حمایت دارد. تا وقتی این سطح " +
                "نگه داشته شود، سناریوی اصلی من ادامه‌ی صعود تا ۲۶۹۰ است.",
