...
object ChartCatalog {
    ...
    val CHART_TYPES: List<ChartTypeOption> = listOf(
        ...
        ChartTypeOption(ChartType.HOLLOW, "کندل توخالی", "hollow", ChartIcon("tv_chart_hollow")),
        ChartTypeOption(ChartType.HEIKIN_ASHI, "هایکین‌آشی", "heikin", ChartIcon("tv_chart_heikin")),
        ChartTypeOption(ChartType.BARS, "میله‌ای (OHLC)", "bars", ChartIcon("tv_chart_bars")),
        ChartTypeOption(ChartType.LINE, "خطی", "line", ChartIcon("tv_chart_line")),
        ChartTypeOption(ChartType.AREA, "ناحیه‌ای", "area", ChartIcon("tv_chart_area")),
        ChartTypeOption(ChartType.RENKO, "رنکو", "renko", ChartIcon("tv_chart_renko")),
        ChartTypeOption(ChartType.RANGE, "رنج", "range", ChartIcon("tv_chart_range")),
        ChartTypeOption(ChartType.LINE_BREAK, "لاین‌بریک", "linebreak", ChartIcon("tv_chart_linebreak")),
        ChartTypeOption(ChartType.KAGI, "کاگی", "kagi", ChartIcon("tv_chart_kagi")),
        ChartTypeOption(ChartType.POINT_AND_FIGURE, "نقطه و رقم", "pnf", ChartIcon("tv_chart_pnf")),
        ...
        ChartTypeOption(ChartType.BASELINE, "خط پایه", "baseline", ChartIcon("tv_chart_baseline")),
        ChartTypeOption(ChartType.HLC_AREA, "ناحیه‌ی HLC", "hlcarea", ChartIcon("tv_chart_hlcarea")),
        ChartTypeOption(ChartType.STEP_LINE, "پلکانی", "step", ChartIcon("tv_chart_step")),
        ChartTypeOption(ChartType.LINE_MARKERS, "خطی با نشانگر", "lwm", ChartIcon("tv_chart_lwm")),
    ...
    val INDICATORS: List<IndicatorOption> = listOf(
        // Trend — on the price.
        IndicatorOption("sma", "میانگین متحرک ساده", "ma", IndicatorPane.PRICE, 0xFFD8A848, ChartIcon("tv_chart_line")),
        IndicatorOption("ema", "میانگین متحرک نمایی", "ema", IndicatorPane.PRICE, 0xFF6E8BE0, ChartIcon("tv_chart_line")),
        IndicatorOption("wma", "میانگین متحرک وزنی", "wma", IndicatorPane.PRICE, 0xFF9B7BE0, ChartIcon("tv_chart_line")),
        IndicatorOption("hma", "میانگین متحرک هال", "hma", IndicatorPane.PRICE, 0xFF4FB3A5, ChartIcon("tv_chart_line")),
        IndicatorOption("bollinger", "باند بولینگر", "bb", IndicatorPane.PRICE, 0xFF8E9BAE, ChartIcon("tv_tool_flatchannel")),
        IndicatorOption("keltner", "کانال کلتنر", "keltner", IndicatorPane.PRICE, 0xFF7FA3C7, ChartIcon("tv_tool_flatchannel")),
        IndicatorOption("donchian", "کانال دونچیان", "donchian", IndicatorPane.PRICE, 0xFFB08BC7, ChartIcon("tv_tool_flatchannel")),
        IndicatorOption("ichimoku", "ایچیموکو", "ichimoku", IndicatorPane.PRICE, 0xFFC77F9B, ChartIcon("tv_chart_hlcarea")),
        IndicatorOption("supertrend", "سوپرترند", "supertrend", IndicatorPane.PRICE, 0xFF00B15C, ChartIcon("tv_tool_trend")),
        IndicatorOption("vwap", "میانگین وزنی حجم", "vwap", IndicatorPane.PRICE, 0xFFE0A85C, ChartIcon("tv_chart_volcandles")),

        // Momentum and volatility — their own scale.
        IndicatorOption("rsi", "شاخص قدرت نسبی", "rsi", IndicatorPane.SEPARATE, 0xFFD8A848, ChartIcon("tv_tool_sine")),
        IndicatorOption("macd", "مکدی", "macd", IndicatorPane.SEPARATE, 0xFF6E8BE0, ChartIcon("tv_chart_columns")),
        IndicatorOption("stochastic", "استوکاستیک", "stoch", IndicatorPane.SEPARATE, 0xFF4FB3A5, ChartIcon("tv_tool_sine")),
        IndicatorOption("cci", "شاخص کانال کالا", "cci", IndicatorPane.SEPARATE, 0xFF9B7BE0, ChartIcon("tv_tool_sine")),
        IndicatorOption("williams", "ویلیامز R%", "willr", IndicatorPane.SEPARATE, 0xFFC77F9B, ChartIcon("tv_tool_sine")),
        IndicatorOption("atr", "میانگین دامنه‌ی واقعی", "atr", IndicatorPane.SEPARATE, 0xFF8E9BAE, ChartIcon("tv_ruler")),
        IndicatorOption("adx", "شاخص میانگین جهت‌دار", "adx", IndicatorPane.SEPARATE, 0xFFE0A85C, ChartIcon("tv_tool_arrowdir")),
        IndicatorOption("choppiness", "شاخص چاپینس", "choppiness", IndicatorPane.SEPARATE, 0xFF7FA3C7, ChartIcon("tv_ruler")),
        IndicatorOption("vortex", "ورتکس", "vortex", IndicatorPane.SEPARATE, 0xFFB08BC7, ChartIcon("tv_tool_arrowdir")),
        IndicatorOption("obv", "حجم متعادل", "obv", IndicatorPane.SEPARATE, 0xFF00B15C, ChartIcon("tv_chart_columns")),

        // ── The second thirty, from indicators_ext_a.js and indicators_ext_b.js ─────────────
        // Trend, on the price.
        IndicatorOption("smma", "میانگین وایلدر (SMMA)", "smma", IndicatorPane.PRICE, 0xFF84CC16, ChartIcon("tv_chart_line")),
        IndicatorOption("zlema", "میانگین با تأخیر صفر", "zlema", IndicatorPane.PRICE, 0xFF2DD4BF, ChartIcon("tv_chart_line")),
        IndicatorOption("kama", "میانگین تطبیقی کافمن", "kama", IndicatorPane.PRICE, 0xFFFB923C, ChartIcon("tv_chart_line")),
        IndicatorOption("t3", "میانگین T3 تیلسون", "t3", IndicatorPane.PRICE, 0xFFE879F9, ChartIcon("tv_chart_line")),
        IndicatorOption("mcginley", "مک‌گینلی داینامیک", "mcginley", IndicatorPane.PRICE, 0xFFFACC15, ChartIcon("tv_chart_line")),
        IndicatorOption("linreg", "منحنی رگرسیون خطی", "linreg", IndicatorPane.PRICE, 0xFF38BDF8, ChartIcon("tv_tool_trend")),
        IndicatorOption("lsma", "میانگین کمترین‌مربعات", "lsma", IndicatorPane.PRICE, 0xFFD8A848, ChartIcon("tv_tool_trend")),
        IndicatorOption("envelopes", "پاکت درصدی", "envelopes", IndicatorPane.PRICE, 0xFFB08BC7, ChartIcon("tv_tool_flatchannel")),

        // Volatility, on its own scale.
        IndicatorOption("stddev", "انحراف معیار", "stddev", IndicatorPane.SEPARATE, 0xFFFB7185, ChartIcon("tv_ruler")),
        IndicatorOption("hv", "نوسان تاریخی", "hv", IndicatorPane.SEPARATE, 0xFFF59E0B, ChartIcon("tv_ruler")),
        IndicatorOption("chaikinVol", "نوسان چایکین", "chaikinVol", IndicatorPane.SEPARATE, 0xFF0EA5E9, ChartIcon("tv_ruler")),
        IndicatorOption("bbpercent", "باند بولینگر ٪B", "bbpercent", IndicatorPane.SEPARATE, 0xFF22D3EE, ChartIcon("tv_tool_sine")),
        IndicatorOption("bbw", "پهنای باند بولینگر", "bbw", IndicatorPane.SEPARATE, 0xFF8E9BAE, ChartIcon("tv_ruler")),

        // Momentum, on its own scale.
        IndicatorOption("mom", "مومنتوم", "mom", IndicatorPane.SEPARATE, 0xFFD8A848, ChartIcon("tv_tool_sine")),
        IndicatorOption("roc", "نرخ تغییر", "roc", IndicatorPane.SEPARATE, 0xFFF472B6, ChartIcon("tv_tool_sine")),
        IndicatorOption("trix", "تریکس (TRIX)", "trix", IndicatorPane.SEPARATE, 0xFF34D399, ChartIcon("tv_tool_sine")),
        IndicatorOption("ac", "شتاب‌دهنده", "ac", IndicatorPane.SEPARATE, 0xFF22D3EE, ChartIcon("tv_chart_columns")),
        IndicatorOption("uo", "اسیلاتور غایی", "uo", IndicatorPane.SEPARATE, 0xFFD8A848, ChartIcon("tv_tool_sine")),
        IndicatorOption("fisher", "تبدیل فیشر", "fisher", IndicatorPane.SEPARATE, 0xFFFB923C, ChartIcon("tv_tool_sine")),
        IndicatorOption("crsi", "کانرز RSI", "crsi", IndicatorPane.SEPARATE, 0xFFE879F9, ChartIcon("tv_tool_sine")),
        IndicatorOption("smiErgodic", "SMI ارگودیک", "smiErgodic", IndicatorPane.SEPARATE, 0xFF38BDF8, ChartIcon("tv_tool_sine")),
        IndicatorOption("smi", "مومنتوم استوکاستیک", "smi", IndicatorPane.SEPARATE, 0xFFFACC15, ChartIcon("tv_tool_sine")),
        IndicatorOption("bop", "توازن قدرت", "bop", IndicatorPane.SEPARATE, 0xFFD8A848, ChartIcon("tv_chart_columns")),

        // Volume, on its own scale.
        IndicatorOption("adline", "تجمع و توزیع", "adline", IndicatorPane.SEPARATE, 0xFF0EA5E9, ChartIcon("tv_chart_volcandles")),
        IndicatorOption("chaikinOsc", "اسیلاتور چایکین", "chaikinOsc", IndicatorPane.SEPARATE, 0xFFF97316, ChartIcon("tv_chart_columns")),
        IndicatorOption("eom", "سهولت حرکت", "eom", IndicatorPane.SEPARATE, 0xFF84CC16, ChartIcon("tv_tool_arrowdir")),
        IndicatorOption("forceIndex", "شاخص نیرو", "forceIndex", IndicatorPane.SEPARATE, 0xFFFB7185, ChartIcon("tv_chart_columns")),
        IndicatorOption("klinger", "اسیلاتور کلینگر", "klinger", IndicatorPane.SEPARATE, 0xFFA855F7, ChartIcon("tv_chart_volcandles")),
        IndicatorOption("pvt", "روند قیمت-حجم", "pvt", IndicatorPane.SEPARATE, 0xFF10B981, ChartIcon("tv_chart_volcandles")),

        // ── The third pack, from indicators_ext_b.js and indicators_ext_c.js ────────────────
        // Trend and trailing stops, on the price.
        IndicatorOption("sar", "پارابولیک سار (SAR)", "psar", IndicatorPane.PRICE, 0xFFE0A85C, ChartIcon("tv_tool_dot")),
        IndicatorOption("alligator", "تمساح ویلیامز (Alligator)", "alligator", IndicatorPane.PRICE, 0xFF6E8BE0, ChartIcon("tv_tool_doublecurve")),
        IndicatorOption("vwma", "میانگین متحرک وزن‌دار حجم (VWMA)", "vwma", IndicatorPane.PRICE, 0xFF10B981, ChartIcon("tv_chart_volcandles")),
        IndicatorOption("tema", "میانگین نمایی سه‌گانه (TEMA)", "tema", IndicatorPane.PRICE, 0xFF2DD4BF, ChartIcon("tv_chart_line")),
        IndicatorOption("dema", "میانگین نمایی دوگانه (DEMA)", "dema", IndicatorPane.PRICE, 0xFF38BDF8, ChartIcon("tv_chart_line")),
        IndicatorOption("chandekroll", "حد ضرر چاند-کرول", "chandekroll", IndicatorPane.PRICE, 0xFFB08BC7, ChartIcon("tv_tool_longshort")),
        IndicatorOption("volstop", "حد ضرر نوسانی", "volstop", IndicatorPane.PRICE, 0xFFF97316, ChartIcon("tv_tool_trend")),
        IndicatorOption("volumeprofile_ind", "پروفایل حجم", "volumeprofile_ind", IndicatorPane.PRICE, 0xFF94A3B8, ChartIcon("tv_tool_volumeprofile")),

        // Momentum and trend strength, on their own scale.
        IndicatorOption("stochrsi", "استوکاستیک RSI", "stochrsi", IndicatorPane.SEPARATE, 0xFF4FB3A5, ChartIcon("tv_tool_sine")),
        IndicatorOption("tsi", "شاخص قدرت واقعی (TSI)", "tsi", IndicatorPane.SEPARATE, 0xFFE879F9, ChartIcon("tv_tool_sine")),
        IndicatorOption("aroon", "آرون (Aroon)", "aroon", IndicatorPane.SEPARATE, 0xFF84CC16, ChartIcon("tv_tool_arrowdir")),
        ...
        IndicatorOption("dmi", "شاخص حرکت جهت‌دار (DMI)", "adx", IndicatorPane.SEPARATE, 0xFFE0A85C, ChartIcon("tv_tool_arrowdir")),
        IndicatorOption("ppo", "اسیلاتور درصدی قیمت (PPO)", "ppo", IndicatorPane.SEPARATE, 0xFF6E8BE0, ChartIcon("tv_chart_columns")),
        IndicatorOption("dpo", "اسیلاتور قیمت بدون روند (DPO)", "dpo", IndicatorPane.SEPARATE, 0xFF9B7BE0, ChartIcon("tv_tool_sine")),
        IndicatorOption("kst", "مجموع نرخ تغییر (KST)", "kst", IndicatorPane.SEPARATE, 0xFFFACC15, ChartIcon("tv_tool_sine")),
        IndicatorOption("cmo", "اسیلاتور مومنتوم چاند (CMO)", "cmo", IndicatorPane.SEPARATE, 0xFFF472B6, ChartIcon("tv_tool_sine")),
        IndicatorOption("coppock", "منحنی کاپاک (Coppock)", "coppock", IndicatorPane.SEPARATE, 0xFF34D399, ChartIcon("tv_tool_curve")),
        IndicatorOption("rvi", "شاخص سرزندگی نسبی (RVI)", "rvi", IndicatorPane.SEPARATE, 0xFF22D3EE, ChartIcon("tv_tool_sine")),
        IndicatorOption("woodiescci", "سی‌سی‌آی وودیز (Woodies CCI)", "woodiescci", IndicatorPane.SEPARATE, 0xFFA855F7, ChartIcon("tv_tool_sine")),
        IndicatorOption("massindex", "شاخص جرم (Mass Index)", "massindex", IndicatorPane.SEPARATE, 0xFF7FA3C7, ChartIcon("tv_ruler")),
        IndicatorOption("ao", "اسیلاتور شگفت‌انگیز (AO)", "ao", IndicatorPane.SEPARATE, 0xFFD8A848, ChartIcon("tv_chart_columns")),
        IndicatorOption("correlation", "ضریب همبستگی", "correlation", IndicatorPane.SEPARATE, 0xFF8E9BAE, ChartIcon("tv_tool_sync")),
        ...
        IndicatorOption("mfi", "شاخص جریان نقدینگی", "mfi", IndicatorPane.SEPARATE, 0xFF0EA5E9, ChartIcon("tv_chart_volcandles")),
        IndicatorOption("cmf", "جریان نقدینگی چایکین", "cmf", IndicatorPane.SEPARATE, 0xFFFB923C, ChartIcon("tv_chart_volcandles")),
        IndicatorOption("pvo", "اسیلاتور درصدی حجم (PVO)", "pvo", IndicatorPane.SEPARATE, 0xFFFB7185, ChartIcon("tv_chart_columns")),
        IndicatorOption("netvolume", "حجم خالص", "netvolume", IndicatorPane.SEPARATE, 0xFFF0B90B, ChartIcon("tv_chart_columns")),

        // ── Structure: levels and marks rather than a value per bar ─────────────────────────
        IndicatorOption("pivots", "پیووت (۵ روش)", null, IndicatorPane.STRUCTURE, 0xFF94A3B8, ChartIcon("tv_tool_hline")),
        IndicatorOption("swings", "نقاط چرخش", null, IndicatorPane.STRUCTURE, 0xFFF59E0B, ChartIcon("tv_tool_arrowdir")),
        IndicatorOption("fractals", "فرکتال ویلیامز", null, IndicatorPane.STRUCTURE, 0xFFF0B90B, ChartIcon("tv_tool_arrowdir")),
        IndicatorOption("zigzag", "زیگزاگ", null, IndicatorPane.STRUCTURE, 0xFFF59E0B, ChartIcon("tv_tool_trend")),
        IndicatorOption("autofib", "فیبوناچی خودکار", null, IndicatorPane.STRUCTURE, 0xFF22D3EE, ChartIcon("tv_tool_fib")),
        IndicatorOption("sr", "حمایت و مقاومت", null, IndicatorPane.STRUCTURE, 0xFFF59E0B, ChartIcon("tv_tool_hline")),
        IndicatorOption("supplydemand", "نواحی عرضه و تقاضا", null, IndicatorPane.STRUCTURE, 0xFF00B15C, ChartIcon("tv_tool_rect")),
