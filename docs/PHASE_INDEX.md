...
- `bootstrap/android-foundation` is the cumulative integration branch and contains all completed Android work through Phase 6 plus documentation-only bookkeeping commits made after the Phase 6 code milestone.
...
## Phase 6 code milestone

`710ede98b19c74244e61048174fdd3939b0cb98a` is the completed and CI-green Phase 6 Android code state. Later commits on `bootstrap/android-foundation` may update only documentation/phase bookkeeping and do not redefine the Phase 6 code milestone.

Phase 6 includes signal-scoped execution, connection UI, idempotency request IDs, quantity validation, explicit execution truth states, active executed-signal loading, and safe close-action gating.
