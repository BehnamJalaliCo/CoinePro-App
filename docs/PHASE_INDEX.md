...
Status: **Ready on dedicated branch.**

Required implementation:
- camera/gallery image input
- explicit symbol/timeframe context
- authenticated image analysis job
- server-truth job lifecycle and quota/entitlement
- validated structured trend/entry/SL/TP/confidence/explanation result
- no raw-model execution and no direct AI execution
- persisted validated signal handoff only
- image lifecycle/privacy cleanup
- dedicated tests plus full Android CI gate

All Phase 8 implementation and closure commits belong on `feat/phase8-ai-vision-flagship`.

## Next phase

Phase 9 starts only after Phase 8 is green and recorded here.
