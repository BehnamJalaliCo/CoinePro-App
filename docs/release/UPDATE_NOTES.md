...
> نسخه‌ی وب پرو چارت مثل یک برنامه نصب می‌شود، با همان آیکون گوشی، و بدون اینترنت هم باز می‌شود. عکس خبرها هم در مرورگر نمایش داده می‌شود.
> در این نسخه‌ی گوشی چیزی عوض نشده است.

**en**

> The Pro Chart web version installs like an app, with the same icon as on your phone, and opens with no
> connection. News photos show in the browser too. Nothing on the phone has changed in this version.
