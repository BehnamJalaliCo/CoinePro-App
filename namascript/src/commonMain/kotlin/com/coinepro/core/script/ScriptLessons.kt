...
object ScriptLessons {
    ...
    val ALL: List<ScriptLesson> = listOf(
        ScriptLesson(
            id = "what",
            title = "نمااسکریپت چیست",
            body = listOf(
                "نمااسکریپت زبان کوچکی است برای نوشتن اندیکاتور خودتان. چیزی که می‌نویسید مستقیم روی همان نموداری که باز است اجرا می‌شود و همان‌جا کشیده می‌شود — نه در یک محیط جدا، نه روی داده‌ای دیگر.",
                "یک اسکریپت چند سطر است. هر سطر یا چیزی را حساب می‌کند و اسم می‌گذارد، یا چیزی روی نمودار می‌کشد. همین.",
                "کد شما روی همین دستگاه اجرا می‌شود. جایی فرستاده نمی‌شود و چیزی از حساب یا سفارش‌های شما نمی‌بیند: نمااسکریپت فقط کندل‌ها را می‌خواند و فقط روی نمودار می‌کشد. اسکریپت نمی‌تواند معامله باز کند.",
            ),
        ...
        ScriptLesson(
            ...
            body = listOf(
                ...
                "پس در نمااسکریپت حلقه (for) وجود ندارد و لازم هم نیست: هر عبارتی که می‌نویسید یک‌بار برای کل نمودار نوشته می‌شود و روی همه‌ی کندل‌ها اجرا می‌شود.",
