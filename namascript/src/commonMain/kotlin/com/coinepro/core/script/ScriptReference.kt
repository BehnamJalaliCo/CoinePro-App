    ...
    val GROUPS: List<ScriptReferenceGroup> = listOf(
        ...
        ScriptReferenceGroup(
            ...
            listOf(
                ...
                ScriptFunction(
                    "signal(condition, buy = true, strength = 1, text = \"متن\")",
                    "شکل کوتاه: می‌گوید اسکریپت روی این کندل‌ها خرید می‌بیند یا فروش. اپ خودش اندازه می‌گیرد که چند بار درست بوده.",
                    "درست/نادرست",
                ),
